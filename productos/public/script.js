        ...
        .then(data => {
            ...
            data.forEach(producto => {
                ...
                fila.innerHTML = `
                    ...
                    <td>
                        <button onclick="editarProducto('${producto.id}', '${producto.nombre}', '${producto.descripcion}', '${producto.marca}', ${producto.stock})">✏️ Editar</button>
...
document.getElementById("formProducto").addEventListener("submit", function(e) {
    ...
    fetch(API_URL, {
        ...
        body: JSON.stringify({ nombre: nombre, descripcion: descripcion, marca: marca, stock: stock })
    })
    .then(response => response.json())
    .then(() => {
...
function editarProducto(id, nombre, descripcion, marca, stock) {
